...
parser.add_argument('--snapshot', default='snapshot/nopad28_ada_1.2/final/model_final.ckpt', type=str)
#parser.add_argument('--snapshot', default='snapshot/nopad28_bn_mini2_test/epoch5/model_1.ckpt', type=str)
